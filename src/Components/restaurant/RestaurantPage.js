...
function RestaurantPage() {
  ...
  let defaultValue = {
    ...
    cuisine: [],
    cuisine_id: [],
    image: "restaurant-bacground-img.png",
    locality: "",
    location_id: -1,
    mealtype_id: -1,
    min_price: 0,
  ...
  let getTokenDetails = ()=>{
   ...
   const [userDetails, setUserDetails]= useState(getTokenDetails());


  let getRestaurantDetails = async () => {
    try {
      let URL = "https://zc-batch-48-api-appliction.herokuapp.com/api/get-restarant-details-by-id/" + id;
  ...
  let getMenuItems = async () => {
    try {
      let URL =
        "https://zc-batch-48-api-appliction.herokuapp.com/api/get-menu-item-list-by-restaurant-id/" + id;
      let { data } = await axios.get(URL);
      if (data.status === true) {
  ...
  let displayRazorpay = async () => {
    ...
    var { data } = await axios.post(
      "https://zc-batch-48-api-appliction.herokuapp.com/api/payment/gen-order",serverData
    );
    console.log(data);

    var order = data.order;
    var options = {
      key: "rzp_test_QX3Cky3BV7YROv", // Enter the Key ID generated from the Dashboard
      ...
      order_id: order.id, //order id generated @ server side
      handler: async function (response) {
        ...
        var { data } = await axios.post(
          "https://zc-batch-48-api-appliction.herokuapp.com/api/payment/verify", sendData
        );
        if (data.status === true) {
          Swal.fire({
            icon: 'Success',
    ...
    <div
                  ...
                  <div className="row p-2" key={index}>
                    ...
                    <div className="col-4 d-flex justify-content-end">
                      <div className="menu-food-item">
                        <img src={"/imges/" + menu_item.image} alt="" />
                        {menu_item.qty === 0 ? (
                          <button
      ...
      <section className="row justify-content-center">
        <section className="col-11 mt-2 restaurant-main-image position-relative">
          <img src={"/imges/" + restaurant.image} className="" alt="ssss" />
        ...
        <section className="col-11">
          ...
          <div className="d-flex justify-content-between align-items-start">
            ...
            >
              ...
              <button className="btn btn-danger" disabled={true}> Please Login to Place the Order</button>
            )
}
          </div>
